...
const findByTipo = (movimento_tipo) =>
    pool.query(
        `SELECT id, prodotto_id, ubicazione_id, quantita,
                tipo, riferimento, note, created_at
     FROM movimenti_stock
...
const findByRiferimento = (riferimento) =>
    pool.query(
        `SELECT id, prodotto_id, ubicazione_id, quantita,
                tipo, riferimento, note, created_at
     FROM movimenti_stock
...
const create = ({ prodotto_id, ubicazione_id, quantita, movimento_tipo, riferimento, note }, client) =>
    (client || pool).query(
